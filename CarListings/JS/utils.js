...
function createCard(car) {
  return `
    <div class="col-md-4">
      ...
      : " <span style='color: green; font-size: 14px;'>Available</span>"}</h5>
  ...
  return `
    <div class="modal fade" id="${car.car_id
      ...
      <div class="row g-3 align-items-center">
        <!-- Product Image -->
        <div class="col-md-6">
        <img src="../../AdminDashboard/Images/${car.url_img}" alt="${car.brand
    } ${car.model}" class="img-fluid rounded shadow-sm" style="height: 400px;">
        </div>
        <!-- Product Details -->
      ...
      <button type="button" id="${car.car_id
